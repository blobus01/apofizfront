...
import "./index.scss";
// Убедитесь, что импорты скелетона правильные (я оставил как в оригинале)
...
const PostDetail = () => {
  ...
  const handleBack = () => {
    // location.state или расширенное поле в history location
    if (location.isPrevPathNotify) {
