...
const HomePostsModule = ({ location, history }) => {
  ...
  return (
    <>
      <div
        className={`home-posts-module ${
          search && search.length > 0 ? "unset" : ""
        }`}
        style={
          searchMode === "organizations" ? { backgroundColor: "white" } : null
        }
      >
        <MobileSearchHeader
          ...
          renderLeft={() => (
            <>
              ...
              <Link to="/faq" className="home-posts-module-header__logo">
                <LogoIcon />
                <LogoTextIcon className="textIcon" />
              </Link>
            </>
          )}
          renderHeader={() => (
        ...
        >
          <ServicesSlider region={getRegion()} />
        </div>
        ...
        >
          <PromotionBanners className="home-posts-module__promo-banners" />
        </div>
        ...
        <div
          className="sticky products-wrap"
          ref={stickyRef}
          style={{
            maxWidth: "1170px",
            margin: "0 auto",
