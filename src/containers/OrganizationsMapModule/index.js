...
const OrganizationsMapModule = ({ onBack }) => {
  ...
  return (
    <div className="organization-map-module">
      ...
      />
      <MapView region={region} search={search} isLoading={isRegionGeoLoading} setSearch={setSearch} />
      {/* {showSearchView ? (
...
export default OrganizationsMapModule;
